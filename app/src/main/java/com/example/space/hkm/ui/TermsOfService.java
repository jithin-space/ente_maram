...
public class TermsOfService extends Activity {
    ...
    public static Intent getIntent(
        ...
        intent.putExtra(ZIP_CODE ,email);
        //email == phone number stored in organization variable
    ...
    public void handleRegisterClick(View view) {
        ...
        String organization = intent.getStringExtra(ZIP_CODE);

        try {
            model = new User(username, firstName, lastName, email, password,organization);
